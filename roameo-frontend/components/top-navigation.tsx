  ...
  return (
    <div className={`flex items-center justify-between px-8 py-3 bg-white shadow-sm ${
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Invite Button - Only show if onInvite is defined */}
        {onInvite && (
          <>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-80 bg-white border border-gray-200 shadow-xl rounded-lg p-2 z-[9999]">
                {inviteLink ? (
                  <>
                    <div className="px-3 pt-2 pb-1 text-sm font-medium text-gray-700">Share this link to invite collaborators:</div>
                    <DropdownMenuItem className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 rounded-lg p-3 transition-all">
            ...
            {showInvitePopover && (
              <div className="absolute right-0 mt-3 w-80 bg-white border border-gray-200 rounded-lg shadow-xl p-2 z-[9999]">
                {inviteLink ? (
                  <>
                    <div className="px-3 pt-2 pb-1 text-sm font-medium text-gray-700">Share this link to invite collaborators:</div>
                    <div className="flex items-center gap-3 cursor-pointer hover:bg-gray-50 rounded-lg p-3 transition-all">
                      <div className="flex items-center gap-2 w-full">
                        <Input 
                          readOnly 
                          value={inviteLink} 
