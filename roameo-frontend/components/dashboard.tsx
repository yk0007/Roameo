  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-white p-6 md:hidden">
        <div className="text-center max-w-sm animate-fade-in">
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            For the best experience, please visit our website on a desktop or
            laptop computer.
          </p>
      ...
      <div className="hidden md:block">
        ...
        {/* Chat Interface */}
        <div
          className={`max-w-4xl mx-auto px-6 py-8 transition-all duration-800 transform ${
            chatVisible
              ? "translate-y-0 opacity-100"
        ...
        {/* Your Trips Section */}
        <div
          className={`max-w-6xl mx-auto px-6 py-12 transition-all duration-1000 transform ${
            cardsVisible
              ? "translate-y-0 opacity-100"
              : "translate-y-20 opacity-0"
          }`}
            ...
            {loading ? (
                ...
                {trips.map((trip: any, index: number) => {
                  ...
                  return (
                    <Card
                      ...
                      onClick={() =>
                        (window.location.href = `/chat?sessionId=${trip.sessionId}`)
                      }
                    >
              ...
              <div className="text-center py-12 animate-fade-in">
                ...
                <p className="text-muted-foreground mb-4">
                  Start planning your first adventure with Roameo
                </p>
